...
<body>
    ...
    //buscamos por los valores ingresados
    $contador=0;
    foreach ($productos as $producto){
            if($producto->{'nombre'}==$valor){
            echo '<form  method="post" name="Agregarcarrito">';
            echo '<div class="modificar">';
            echo '<div>';
            echo '<p>Nombre:</p>';
            echo '<input type="text" name="nombre" value="'.$producto->{'nombre'}.'" readonly>';
            echo '</div>';
            echo '<div>';
            echo '<p>Precio:</p>';
            echo '<input type="number" name="precio" value="'.$producto->{'precio'}.'" readonly>$';
            echo '</div>';
            echo '<div >';
            echo '<p>Cantidad:</p>';
            echo '<input style="width: 60%;" type="number" name="cantidad" size="2" max="10" min="1">';
            echo '</div>';
            echo '<div style="grid-column: 2/3">';
            echo '<input style="width: 67%;" type="submit" name="btnagregar" value="Modificar" id="btnagregar"> ';
            echo '</div>';
            echo '</div>';
            echo '</form>';
            break;
    ...
    //guardamos datos en archivo json
...
}else
{
    ...
    <a class="btn-regresar btn-registro" href="leerJSON.php">Regresar</a>
    </div>
    </main>
