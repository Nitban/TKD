...
<body>
    ...
    <main class="contenedor">
        ...
        <div class="nosotros">
            ...
            <img class="nosotros__imagen" src="imgTienda/nosotros.jpg" alt="imagen nosotros">
        </div>
    </main>
    ...
    <section class="contenedor comprar">
        ...
        <div class="bloques">
            <div class="bloque">
                <img class="bloque__imagen" src="imgTienda/icono_1.png" alt="porque comprar">
            ...
            <div class="bloque">
                <img class="bloque__imagen" src="imgTienda/icono_2.png" alt="porque comprar">
            ...
            <div class="bloque">
                <img class="bloque__imagen" src="imgTienda/icono_3.png" alt="porque comprar">
            ...
            <div class="bloque">
                <img class="bloque__imagen" src="imgTienda/icono_4.png" alt="porque comprar">
