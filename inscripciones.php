...
<body>
    ...
    <main class="contenedor-info sombra">
        <h2>Inscribete ahora mismo</h2>

        <div class="informacion">
            <h3> ¿Que es el Taekwondo? </h3>

            <p>Taekwondo es un término que procede del coreano y que hace
                referencia a un arte marcial del mismo origen. Este deporte
                combina técnicas del kung fu, el karate-do y otras disciplinas
                más antiguas.
                Taekwondo
                La expresión se forma por tres términos: tae (que refiere a la utilización de los pies),
                kwon (vinculado a los brazos y puños) y do (una noción filosófica que se asocia al camino
                hacia la perfección). La frase “tae kwon do”, por lo tanto, alude al uso de los pies y
                las manos en una técnica que, por extensión, no apela a ninguna clase de armamento.</p>

            <div class="imageninfo">
                <img class="imagenprincipal" src="img/principal.jpg" alt="imagen sobre taekwondo">
            </div>

        </div>

        <div class="conocenos">
            <img class="imgconoce" src="img/imagen1.jpg" alt="imagen sobre taekwondo">
            <p>
                El TaeKwonDo es un deporte ideal para los chicos y chicas a temprana edad, 
                debido a que este les ayuda a desarrollar Psicomotricidad y a cordinar todos
                sus movimientos, haciendolo especialmente recomendado para sus hijos a temprana 
                edad, ¡Animate!
            </p>
        ...
        <div class="infos">
            ...
            <section class="info">
                ...
                <p>
                El TaeKwonDo tiene sus beneficios: 
                ...
                -Potencia el conocimiento del cuerpo, es decir,
                aumenta las habilidades y la confianza de los niños para realizar cualquier actividad
            ...
            <section class="info">
                ...
                <p>Conocenos más en cualquiera de nuestras redes sociales, siguenos en 
                Facebook, Twitter, Instagrama, Pinterest o nuestro canal de YouTube</p>
            </section>

        </div>
        <!--inscripcioon-->

        <!--Imagenes sobre el taekwondo-->
        <section class="estiloboton">
            <div class="buton">
                <a class="boton btn btn-white btn-animate" onclick="registar()">Registrate</a>
            </div>
        </section>
    </main>
