...
<body>
    ...
    <main class="contenedor-info sombra">
        ...
        <div class="informacion">
            <h3>¿Que son lo torneos?</h3>

            <p>Los torneos son competiciones donde el alumno puede desarrollar sus habilidades, 
            aprender de los demás, conocer a nuevo compañeros y experimentar el ambiente del 
            TaeKwonDo, en sus diferentes ramas el alumno puede destacar dependiendo de sus 
            habilidades, ganando medallas y trofeos para su progreso. 
            
            </p>

            <div class="imageninfo">
                <img class="imagenprincipal" src="img/torneo.jpg" alt="imagen sobre torneo">
            </div>
        ...
        <div class="conocenos">
            ...
            <p>
            Conocenos más en cualquiera de nuestras redes sociales, siguenos en 
            Facebook, Twitter, Instagrama, Pinterest o nuestro canal de YouTube
            </p>
