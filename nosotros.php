...
<body>
    ...
    <main class="contenedor-info sombra">
        ...
        <h2>TaeKwondo Master</h2>
          <div class="nosotros-tkd">
            <p>
            Esto es un proyecto de software dedicado a la administración de las escuelas
            de TaeKwonDo, esto surge de la observacion a las escuelas tradicionales y sus 
            dificultades para administrar a sus alumnos, debido a que lo hacen por medio 
            de papeles y herramientas mas rudimentarias, esta pagina web con sus multiples
            herramientas solucionara sus problemas. 
            </p>
            <img class="nosotros-img-tkd" src="img/imagen2.jpg" alt="imagen sobre taekwondo">
          </div>
        <h2>Programadores</h2>
          <div class="nosotros-tkd">
            <p> Carlos Jair Rodiles Olivares 17300673 8C1</p>
            <p> Cesar Yael Jauregui Landeros 17300562 8C1</p>
            <p> Tecnologos en Desarrollo de Software Egresados de Centro de Enseñanza Tecnica Industrial Tonalá <p>
            <img class="nosotros-img-tkd" src="img/imagen3.jpg" alt="imagen sobre taekwondo">
          </div>
